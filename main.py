...
from capturar_dados_de_rds import captura_dados_cliente
...
def main():
    ...
    credenciais = retorna_credenciais(data_science = False)
    ...
    for cliente in credenciais:
        ...
        print(' ', end = '\n', flush = True)
        df_transacoes = captura_dados_cliente(False, cliente)
        print('temp:{}'.format((time.time()-beg)/60))
